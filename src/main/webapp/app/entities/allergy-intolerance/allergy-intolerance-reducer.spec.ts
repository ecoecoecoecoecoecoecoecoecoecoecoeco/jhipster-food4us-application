...
import reducer, {
  ...
  reset,
  updateEntity,
} from './allergy-intolerance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALLERGYINTOLERANCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALLERGYINTOLERANCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALLERGYINTOLERANCE actions', async () => {
      const arg = { id: 4800 };
    ...
    it('dispatches UPDATE_ALLERGYINTOLERANCE actions', async () => {
      const arg = { id: 4800 };
    ...
    it('dispatches PARTIAL_UPDATE_ALLERGYINTOLERANCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ALLERGYINTOLERANCE actions', async () => {
      const arg = 42666;
