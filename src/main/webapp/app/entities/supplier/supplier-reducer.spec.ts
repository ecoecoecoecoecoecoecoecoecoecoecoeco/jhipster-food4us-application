...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './supplier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLIER actions', async () => {
      const arg = { id: 5063 };
    ...
    it('dispatches UPDATE_SUPPLIER actions', async () => {
      const arg = { id: 5063 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLIER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLIER actions', async () => {
      const arg = 42666;
