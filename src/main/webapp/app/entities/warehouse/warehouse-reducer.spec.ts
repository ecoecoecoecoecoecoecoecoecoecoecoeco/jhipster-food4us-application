...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './warehouse.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WAREHOUSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WAREHOUSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WAREHOUSE actions', async () => {
      const arg = { id: 31486 };
    ...
    it('dispatches UPDATE_WAREHOUSE actions', async () => {
      const arg = { id: 31486 };
    ...
    it('dispatches PARTIAL_UPDATE_WAREHOUSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WAREHOUSE actions', async () => {
      const arg = 42666;
