...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIETARYENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIETARYENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIETARYENTRY actions', async () => {
      const arg = { id: 26266 };
    ...
    it('dispatches UPDATE_DIETARYENTRY actions', async () => {
      const arg = { id: 26266 };
    ...
    it('dispatches PARTIAL_UPDATE_DIETARYENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIETARYENTRY actions', async () => {
      const arg = 42666;
