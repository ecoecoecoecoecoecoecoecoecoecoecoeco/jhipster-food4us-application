...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGREDIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INGREDIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INGREDIENT actions', async () => {
      const arg = { id: 26974 };
    ...
    it('dispatches UPDATE_INGREDIENT actions', async () => {
      const arg = { id: 26974 };
    ...
    it('dispatches PARTIAL_UPDATE_INGREDIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INGREDIENT actions', async () => {
      const arg = 42666;
