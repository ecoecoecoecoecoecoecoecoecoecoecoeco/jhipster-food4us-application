...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './recipe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECIPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECIPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECIPE actions', async () => {
      const arg = { id: 32502 };
    ...
    it('dispatches UPDATE_RECIPE actions', async () => {
      const arg = { id: 32502 };
    ...
    it('dispatches PARTIAL_UPDATE_RECIPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECIPE actions', async () => {
      const arg = 42666;
