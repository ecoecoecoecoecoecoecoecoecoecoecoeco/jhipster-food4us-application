...
import static com.eco.food4us.domain.UserProfileAsserts.*;
...
import com.eco.food4us.repository.UserProfileRepository;
import com.eco.food4us.repository.UserRepository;
import com.eco.food4us.service.UserProfileService;
import com.eco.food4us.service.dto.UserProfileDTO;
import com.eco.food4us.service.mapper.UserProfileMapper;
...
class UserProfileResourceIT {
    ...
    private static final UserType DEFAULT_USER_TYPE = UserType.DOMESTIC;
    private static final UserType UPDATED_USER_TYPE = UserType.PROFESSIONAL;
    ...
    public static UserProfile createEntity() {
        return new UserProfile().userType(DEFAULT_USER_TYPE);
    }
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile().userType(UPDATED_USER_TYPE);
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.userType(UPDATED_USER_TYPE);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.userType(UPDATED_USER_TYPE);
